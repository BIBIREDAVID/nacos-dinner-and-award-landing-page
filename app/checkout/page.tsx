...
function CheckoutContent() {
  ...
  const ticketData = {
    regular: { name: isTestMode ? 'Standard Pass (TEST)' : 'Standard Pass', price: isTestMode ? 100 : 50, capacity: '1 Guest', id: 'regular' },
    couples: { name: 'Couples Pass', price: 50, capacity: '2 Guests', id: 'couples' },
    table:   { name: 'Table of 5',   price: 50, capacity: '5 Guests', id: 'table'   },
  };
